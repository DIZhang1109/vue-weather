<template>
	<div id="app">
		...
		<div v-else>
			<h4>{{ today }}</h4>
			<span>{{ todayMaxTemp | format }} / {{ todayMinTemp | format }}</span><br>
			<span>{{ todayDayCond | capitalize }} / {{ todayNightCond | capitalize }}</span><br>
			<h4>{{ tomorrow }}</h4>
			<span>{{ tomorrowMaxTemp | format }} / {{ tomorrowMinTemp | format }}</span><br>
			<span>{{ tomorrowDayCond | capitalize }} / {{ tomorrowNightCond | capitalize }}</span><br>
			<h4>{{ theDayAfterTomorrow }}</h4>
			<span>{{ theDayAfterTomoMaxTemp | format}} / {{ theDayAfterTomoMinTemp | format}}</span><br>
			<span>{{ theDayAfterTomoDayCond | capitalize }} / {{ theDayAfterTomoNightCond | capitalize }}</span><br>
		</div>
	</div>
</template>
